...
export const translations = {
  en: {
    ...
    dashboard: {
      ...
      trialLimit: "Free plan limit reached",
    ...
    upgrade: {
      ...
      subtitle: "Unlock unlimited tracking and premium insights with Pro.",
      lifetimeAccess: "Pro Subscription",
      oneTimePayment: "Monthly or yearly billing",
      features: {
      ...
      ctaButton: "Continue to Checkout",
    ...
    paymentSuccess: {
      ...
      message: "Your Pro subscription will be activated shortly. You’ll have access to all premium features.",
      status: "Pro subscription activated",
      cta: "Go to Dashboard",
    },
    // Payment Cancel
    paymentCancel: {
  ...
  tr: {
    ...
    dashboard: {
      ...
      trialLimit: "Ücretsiz plan limiti doldu",
    ...
    upgrade: {
      title: "Pro'ya Geç",
      subtitle: "Pro ile sınırsız takip ve premium içgörülerin kilidini açın.",
      lifetimeAccess: "Pro Abonelik",
      oneTimePayment: "Aylık veya yıllık faturalama",
      features: {
    ...
    paymentSuccess: {
      ...
      message: "Pro aboneliğiniz kısa süre içinde aktif olacak. Tüm premium özelliklere erişeceksiniz.",
      status: "Pro abonelik aktif",
      cta: "Panele Git",
    },
    paymentCancel: {
      ...
      reason4: "İstediğiniz zaman iptal edin",
  ...
  de: {
    ...
    dashboard: {
      ...
      trialLimit: "Kostenloses Planlimit erreicht",
    ...
    upgrade: {
      ...
      subtitle: "Schalten Sie unbegrenztes Tracking und Premium-Insights mit Pro frei.",
      lifetimeAccess: "Pro-Abonnement",
      oneTimePayment: "Monatliche oder jährliche Abrechnung",
      features: {
    ...
    paymentSuccess: {
      ...
      message: "Ihr Pro-Abonnement wird in Kürze aktiviert. Sie erhalten Zugriff auf alle Premium-Funktionen.",
      status: "Pro-Abonnement aktiviert",
      cta: "Zum Dashboard",
    },
    paymentCancel: {
  ...
  es: {
    ...
    dashboard: {
      ...
      trialLimit: "Límite del plan gratuito alcanzado",
    ...
    upgrade: {
      ...
      subtitle: "Desbloquea el seguimiento ilimitado y las ideas premium con Pro.",
      lifetimeAccess: "Suscripción Pro",
      oneTimePayment: "Facturación mensual o anual",
      features: {
    ...
    paymentSuccess: {
      ...
      message: "Tu suscripción Pro se activará en breve. Tendrás acceso a todas las funciones premium.",
      status: "Suscripción Pro activada",
      cta: "Ir al Panel",
    },
    paymentCancel: {
      ...
      reason4: "Cancela cuando quieras",
  ...
  fr: {
    ...
    dashboard: {
      ...
      trialLimit: "Limite du plan gratuit atteinte",
    ...
    upgrade: {
      title: "Passer à Pro",
      subtitle: "Débloquez le suivi illimité et les insights premium avec Pro.",
      lifetimeAccess: "Abonnement Pro",
      oneTimePayment: "Facturation mensuelle ou annuelle",
      features: {
      ...
      ctaButton: "Continuer vers le paiement",
    ...
    paymentSuccess: {
      ...
      message: "Votre abonnement Pro sera activé sous peu. Vous aurez accès à toutes les fonctionnalités premium.",
      status: "Abonnement Pro activé",
